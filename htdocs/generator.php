<aside class="sidebar">
    ...
    <div class="sidebar-section" style="padding-bottom: 10px; padding-top: 15px;">
        <button class="accordion-btn" :class="{ active: isAiMenuOpen }" @click="isAiMenuOpen = !isAiMenuOpen">
            <span>🤖 Yapay Zeka ile Otomatik Üret</span>
            <span class="icon">▼</span>
        </button>
        
        <div class="accordion-content" v-show="isAiMenuOpen">
    ...
    <div class="sidebar-section">
        <h2>2. Chatlog Metni <span style="font-size: 0.7rem; font-weight: normal; color: var(--success);">(Manuel de yazabilirsin)</span></h2>
